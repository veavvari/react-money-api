...
export default class MoneyApi extends Component {
  // PrettyPrintJson = (data) =>  (<div><pre>{JSON.stringify(data, null, 2) }</pre></div>);
      ...
      <div>
        ...
        <div className="complete-api">
          ...
          <div>
            ...
            <table class="table">
              <thead>
                <tr class="table-active">
                  <th width="200" className="table-header">
                    Name
                  </th>
                  <th width="200" className="table-header">
                    Required
            ...
            <div>
              <div className="response-header">Response Sample</div>
